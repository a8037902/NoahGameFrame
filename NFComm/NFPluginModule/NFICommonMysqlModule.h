...
#ifndef NFI_COMMON_MYSQL_MODULE_H
#define NFI_COMMON_MYSQL_MODULE_H

#include "NFIModule.h"

class NFICommonMysqlModule
    : public NFIModule
{
public:
	...
	virtual bool SavePropertyInfo(const NFGUID& self, const std::string& strClassName, NF_SHARE_PTR<NFIPropertyManager> pPropertyManager, const int nExpireSecond = 0) = 0;
	virtual bool SaveRecordInfo(const NFGUID& self, const std::string& strClassName, NF_SHARE_PTR<NFIRecordManager> pRecordManager, const int nExpireSecond = 0) = 0;
};
