...
const EGameEventCode EGameEventCode_MAX = EGEC_LEAVE_CLAN_SUCCESS;
...
enum EGameMsgID {
  ...
  EGMI_REQ_LOAD_OBJ_DATA = 144,
  EGMI_ACK_LOAD_OBJ_DATA = 145,
  EGMI_REQ_SAVE_OBJ_DATA = 146,
  EGMI_ACK_SAVE_OBJ_DATA = 147,
...
enum EGameItemExpiredType {
  ...
  EGIET_REAL_TIME = 2,
  EGIET_END_INDEX = 3,
  EGameItemExpiredType_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  EGameItemExpiredType_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
...
enum EDrawDropItemState {
  ...
  E_DRAW_STATE_GAIN = 1,
  E_DRAW_STATE_RECV = 2,
  EDrawDropItemState_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  EDrawDropItemState_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
...
enum EGuildPowerType {
  ...
  EGuildPowerType_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  EGuildPowerType_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
LIBPROTOC_EXPORT bool EGuildPowerType_IsValid(int value);
const EGuildPowerType EGuildPowerType_MIN = CLAN_POWER_TYPE_NORMAL;
const EGuildPowerType EGuildPowerType_MAX = CLAN_POWER_TYPE_PRESIDENT;
...
enum ETaskState {
  ...
  TASK_DRAW_AWARD = 2,
  TASK_FINISH = 3,
  ETaskState_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  ETaskState_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
...
enum ETaskType {
  ...
  ETaskType_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  ETaskType_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
...
enum EPVPType {
  ...
  PVP_CLAN_WAR = 4,
  PVP_CLAN_DUNGEON = 5,
  EPVPType_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  EPVPType_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
LIBPROTOC_EXPORT bool EPVPType_IsValid(int value);
const EPVPType EPVPType_MIN = PVP_HOME;
const EPVPType EPVPType_MAX = PVP_CLAN_DUNGEON;
...
enum EShopType {
  ...
  EST_GEM = 6,
  EST_CARD = 7,
  EShopType_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  EShopType_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
LIBPROTOC_EXPORT bool EShopType_IsValid(int value);
const EShopType EShopType_MIN = EST_UNKNOW;
...
enum ERankType {
  ...
  ERankType_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  ERankType_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
LIBPROTOC_EXPORT bool ERankType_IsValid(int value);
const ERankType ERankType_MIN = ERT_UNKNOW;
const ERankType ERankType_MAX = ERT_CLAN_KINGSOURCE;
...
enum EPropertyType {
  ...
  EPT_AGILITY = 2,
  EPT_INTELLIGENCE = 3,
  EPropertyType_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  EPropertyType_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
LIBPROTOC_EXPORT bool EPropertyType_IsValid(int value);
const EPropertyType EPropertyType_MIN = EPT_UNKNOW;
...
enum EGameElementType {
  ...
  EELEMENTTYPE_DARK = 5,
  EGameElementType_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  EGameElementType_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
