...
namespace NFrame
{
	...
	public:
		...
		static const std::string& FightHeroHP1(){ static std::string x = "FightHeroHP1"; return x; };// int
		static const std::string& FightHeroHP2(){ static std::string x = "FightHeroHP2"; return x; };// int
