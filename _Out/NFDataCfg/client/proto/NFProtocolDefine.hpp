...
namespace NFrame
{
	...
	public:
		//Class name
		static const std::string& ThisName(){ static std::string x = "Client"; return x; };		// IObject
		static const std::string& ClassName(){ static std::string x = "ClassName"; return x; };// string
		static const std::string& ConfigID(){ static std::string x = "ConfigID"; return x; };// string
		static const std::string& GroupID(){ static std::string x = "GroupID"; return x; };// int
		static const std::string& ID(){ static std::string x = "ID"; return x; };// string
		...
		static const std::string& ClientServerID(){ static std::string x = "ClientServerID"; return x; };// int
		static const std::string& GameServerID(){ static std::string x = "GameServerID"; return x; };// int
		static const std::string& LoginServerID(){ static std::string x = "LoginServerID"; return x; };// int
		static const std::string& Password(){ static std::string x = "Password"; return x; };// string
		static const std::string& RoleID(){ static std::string x = "RoleID"; return x; };// int
		static const std::string& WebPort(){ static std::string x = "WebPort"; return x; };// int
		static const std::string& WorldServerID(){ static std::string x = "WorldServerID"; return x; };// int
		// Record
	...
	public:
		...
		public:
			...
			static const int ReliveTime = 6;//int
			static const int HP = 7;//int
			static const int Ice_Talent = 8;//int
			static const int Fire_Talent = 9;//int
			static const int Light_Talent = 10;//int
			static const int Wind_Talent = 11;//int
			static const int Poison_Talent = 12;//int
			static const int Dark_Talent = 13;//int
